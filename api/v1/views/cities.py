#!/usr/bin/python3
""" system that process all default RestFul API actions for cities """
...
def get_cities(state_id):
    """
    free the list of all cities systems
...
def get_city(city_id):
    """
    free a specific city based on identity
    """
