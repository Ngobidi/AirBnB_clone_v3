#!/usr/bin/python3
""" system that process all default RestFul API actions for Place_Amenity """
...
def get_place_amenities(place_id):
    """
    free the list of all Amenity of a Place
    """
...
def delete_place_amenity(place_id, amenity_id):
    """
    rm a Amenity objects of a Place
    """
    place = storage.get(Place, place_id)
...
def post_place_amenity(place_id, amenity_id):
    """
    connect a Amenity objects to a Places
    """
    place = storage.get(Place, place_id)
